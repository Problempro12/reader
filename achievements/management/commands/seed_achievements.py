                ...
                if not existing_achievement:
                    await prisma.achievement.create(
                        data={
                            ...
                            "criteria": json.dumps(achievement_data['criteria']), # Convert dict to JSON string
                            "reward": achievement_data['reward']
                        }
                    )
                    self.stdout.write(self.style.SUCCESS('Successfully added achievement: {}.'.format(achievement_data['name'])))
                else:
                    self.stdout.write(self.style.WARNING('Achievement already exists: {}.'.format(achievement_data['name'])))
